        ...
        <el-menu :default-active="$route.path" class="el-menu-vertical-demo" @open="handleopen" @close="handleclose" @select="handleselect" unique-opened router v-show="!collapsed">
          <template v-for="(item, index) in $router.options.routes" v-if="!item.hidden">
            <el-submenu :index="index+''" v-if="!item.leaf" :key="index+''">
              ...
              <el-menu-item v-for="child in item.children" :index="child.path" :key="child" v-if="!child.hidden">{{child.name}}</el-menu-item>
            </el-submenu>
...
export default {
  ...
  mounted() {
    ...
    if (user) {
      ...
      this.sysUserName = user.name || this.sysUserName;
